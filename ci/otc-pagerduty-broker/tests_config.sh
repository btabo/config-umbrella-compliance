...
# secrets
export OTC_API_BROKER_SECRET=$(cat $CONFIG_FOLDER/otc_OTC_API_SECRET)       
...
export CLOUDANT_IAM_API_KEY=$(cat $CONFIG_FOLDER/otc-pagerduty-broker_CLOUDANT_IAM_API_KEY)
